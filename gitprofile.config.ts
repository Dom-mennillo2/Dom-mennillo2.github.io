...
const CONFIG = {
  github: {
    username: 'Dom-mennillo2', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Mennillo Domenico',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'domenico-mennillo-158a3114a',
    medium: '@mennillodomenico',
 ...
 /* publications: [
  ...
  blog: {
    ...
    username: '@mennillodomenico', // to hide blog section, keep it empty
